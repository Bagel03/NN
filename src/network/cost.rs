...
struct DataPoint<const SIZES: &'static [usize]>
where
    [(); idx(SIZES, 0)]:,
    [(); outputs(SIZES)]:,
{
...
where
    ...
    [(); outputs(SIZES)]:,
{
    fn cost(&self, data_point: DataPoint<SIZES>) -> f64 {
    ...
    fn cost_derivative(&self, actual_output: f64, expected_output: f64) -> f64 {
        actual_output - expected_output
    }

    fn total_cost<const T: usize>(&self, data_points: [DataPoint<SIZES>; T]) -> f64 {
